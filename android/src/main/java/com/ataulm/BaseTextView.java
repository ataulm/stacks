...
public class BaseTextView extends TextView {
    ...
    private static class TypefaceFactory {
        ...
        private int getFontId(Context context, AttributeSet attrs) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BaseTextView);
            if (typedArray == null) {
                return INVALID_FONT_ID;
            }

            try {
                return typedArray.getInt(R.styleable.BaseTextView_textFont, INVALID_FONT_ID);
            } finally {
                typedArray.recycle();
            }
        }
